...
character characters[5] = {
    {.last_name = "Ripley",
     ...
     .max_actions = 4,
     .held_items = {0, 0, 0},
     .ability_description = "Spend an action: Move another crewmember 1 SPACE",
     .ability_function = ripley_ability},
    {.last_name = "Dallas",
     .first_name = "Arthur",
     .rank = "Captain",
     .max_actions = 5,
     ...
     .ability_function = dallas_ability},
    {.last_name = "Parker",
     .first_name = "Dennis",
     .rank = "Chief Engineer",
     .max_actions = 4,
     .held_items = {0, 0, 0},
     .ability_description = "Spend an action: Add 1 Scrap to your inventory "
                            "from the Scrap pile. Use "
                            "only once per turn.",
     .ability_function = parker_ability},
    {.last_name = "Brett",
     .first_name = "Samson",
     ...
     .ability_description =
         ...
         "craft.",
     .ability_function = brett_ability},
    {.last_name = "Lambert",
     .first_name = "Joan",
     .rank = "Navigator",
     .max_actions = 4,
     ...
     .ability_function = lambert_ability},
};
